...
<body>
    <div class="bg-gray-900 p-2">
        ...
        <form action="" method="POST">
            ...
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" name="image" id="image" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" value="<?= $waifu['image']; ?>" placeholder=" " required />
